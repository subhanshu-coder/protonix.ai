...
export function SlidingLogoMarquee({
  ...
  // Update container dimensions on resize (optional for advanced usage)
  ...
  // Handle clicking a marquee item
  ...
  // Blur div overlays for edge fade effect
  ...
  return (
    <>
      ...
      <div
        ref={containerRef}
        className={`sliding-marquee-container relative ${className ?? ""}`}
        style={{
          width,
